	...
	private void personFactory(PersonAgent p, String job, PersonGui gui) {
		...
		if(!job.equals("No job")){
			...
			if(job.contains("Restaurant2")){
				...
				if(r instanceof MarketWorkerRole){

					switch(workerMarketCounter) {
					case 0: 
						market1.addWorker((MarketWorkerRole)r);
						p.addFirstJob(r, "mark1", 2);
						break;
					case 1: 
						market2.addWorker((MarketWorkerRole)r);
						p.addFirstJob(r, "mark2", 2);
						break;
					case 2: 
						market3.addWorker((MarketWorkerRole)r);
					...
					case 0: 
						market1.setManager((MarketManagerRole)r);
						p.addFirstJob(r, "mark1", 1);
						break;
					case 1: 
						market2.setManager((MarketManagerRole)r);
						p.addFirstJob(r, "mark2", 1);
						break;
					case 2: 
						market3.setManager((MarketManagerRole)r);
	...
	public Role getNewRole(String type, PersonAgent p){
		...
		if(type.equals("Restaurant2 WaiterSharedData")){
			...
			if (type.contains("1")){
				...
				MarketManagerRole role2 = new MarketManagerRole(p.getName(), p, market2);
				role2.setPerson(p);
				MarketGui mktGui = new MarketGui(); 
				...
				MarketManagerRole role3 = new MarketManagerRole(p.getName(), p, market3);
				role3.setPerson(p);
				MarketGui mktGui = new MarketGui(); 
			...
			if (type.contains("1")){
				...
				MarketWorkerRole role2 = new MarketWorkerRole(p);
				role2.setPerson(p);
				MarketGui mktGui = new MarketGui(); 
				...
				MarketWorkerRole role3 = new MarketWorkerRole(p);
				role3.setPerson(p);
				MarketGui mktGui = new MarketGui(); 
