 ...
 */
public class Restaurant5Gui extends JFrame implements ActionListener {
    /* The GUI has two frames, the control frame (in variable gui) 
     * and the animation frame, (in variable animationFrame within gui)
     */
	//JFrame animationFrame = new JFrame("Restaurant Animation");
	Restaurant5 restaurant5 = new Restaurant5();
	Restaurant5AnimationPanel animationPanel = new Restaurant5AnimationPanel(restaurant5);
    ...
    public void updateInfoPanel(Object person) {
        ...
        else if (person instanceof Restaurant5WaiterRole) {
            Restaurant5WaiterRole waiter = (Restaurant5WaiterRole) person;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == stateCB) {
            ...
            else if(currentPerson instanceof Restaurant5WaiterRole) {
            	Restaurant5WaiterRole w = (Restaurant5WaiterRole) currentPerson;
    ...
    public static void main(String[] args) {
        Restaurant5Gui gui = new Restaurant5Gui();
