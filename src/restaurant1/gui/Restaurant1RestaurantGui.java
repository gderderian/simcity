 ...
 */
public class Restaurant1RestaurantGui extends JFrame implements ActionListener, ChangeListener {
    ...
    private Restaurant1RestaurantPanel restPanel = new Restaurant1RestaurantPanel(this);
     ...
     */
    public Restaurant1RestaurantGui() {
    ...
    public void updateInfoPanel(Object person) {
        ...
        if(person instanceof Restaurant1WaiterRole) {
    ...
    public static void main(String[] args) {
        Restaurant1RestaurantGui gui = new Restaurant1RestaurantGui();
