 ...
 */
public class Restaurant1ListPanel extends JPanel implements ActionListener {
	...
	private Restaurant1RestaurantPanel restPanel;
	private String type;
	 ...
	 */
	public Restaurant1ListPanel(Restaurant1RestaurantPanel rp, String type) {
		restPanel = rp;
		this.type = type;
