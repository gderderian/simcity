 ...
 *
 */
public class Restaurant1EventLog {

	/**
	 * This is the backing data store for the list of events.
	 */
	private LinkedList<Restaurant1LoggedEvent> events = new LinkedList<Restaurant1LoggedEvent>();
	 ...
	 * @param e
	 */
	public void add(Restaurant1LoggedEvent e) {
		events.add(e);
	}
	...
	public boolean containsString(String message) {
		for (Restaurant1LoggedEvent e : events) {
	 ...
	 *         string
	 */
	public Restaurant1LoggedEvent getFirstEventWhichContainsString(String message) {
		for (Restaurant1LoggedEvent e : events) {
			if (e.getMessage().contains(message)) {
				return e;
			}
	 ...
	 */
	public Restaurant1LoggedEvent getLastLoggedEvent() {
