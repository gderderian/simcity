...
import restaurant1.Restaurant1CashierRole.MyCustomer;
...
public class CashierMixedTest2 extends TestCase
{
	...
	Restaurant1MockCustomer customer1;
	Restaurant1MockCustomer customer2;
	Restaurant1MockCustomer customer3;
	Restaurant1MockCustomer customer4;
	Restaurant1MockWaiter waiter1;
	Restaurant1MockWaiter waiter2;
	String orderFood1;
	String orderFood2;
	String orderFood3;
	Restaurant1MockMarket market1;
	double billAmount1;
	
	public void setUp() throws Exception {
		super.setUp();		
		cashier = new Restaurant1CashierRole("cashier");
		waiter1 = new Restaurant1MockWaiter("waiter1");
		waiter2 = new Restaurant1MockWaiter("waiter2");
		
		customer1 = new Restaurant1MockCustomer("customer1");
		customer2 = new Restaurant1MockCustomer("customer2");
		customer3 = new Restaurant1MockCustomer("customer3");
		customer4 = new Restaurant1MockCustomer("customer4");
		orderFood1 = "chicken";
		orderFood2 = "fish";
		orderFood3 = "steak";		
		
		market1 = new Restaurant1MockMarket("market1");
	...
	public void testOneCustomerCheck() {		
		...
		Restaurant1Check check1 = cashier.checks.get(0).c; 
		Restaurant1Check check2 = cashier.checks.get(1).c;
		...
		Restaurant1Check check3 = cashier.checks.get(2).c; 
		Restaurant1Check check4 = cashier.checks.get(3).c;
