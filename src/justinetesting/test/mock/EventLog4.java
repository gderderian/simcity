 ...
 *
 */
public class EventLog4 {

	/**
	 * This is the backing data store for the list of events.
	 */
	private LinkedList<LoggedEvent4> events = new LinkedList<LoggedEvent4>();
	 ...
	 * @param e
	 */
	public void add(LoggedEvent4 e) {
		events.add(e);
	}
	 ...
	 *         string
	 */
	public LoggedEvent4 getFirstEventWhichContainsString(String message) {
		for (LoggedEvent4 e : events) {
			if (e.getMessage().contains(message)) {
				return e;
			}
	 ...
	 */
	public LoggedEvent4 getLastLoggedEvent() {
